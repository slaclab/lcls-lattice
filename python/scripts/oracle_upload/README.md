...
6. Edit the header of ../python/scripts/oracle_upload/prepare_upload.py with the release name.
7. Execute ~/git_repos/lcls-lattice/python/scripts/oracle_upload/prepare_upload.py
