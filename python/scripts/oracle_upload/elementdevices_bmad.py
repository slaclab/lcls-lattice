...
cav_devices('cu_hxr_survey.tape', 'elementdevices_cavities_cuH.dat')
cav_devices('cu_sxr_survey.tape', 'elementdevices_cavities_cuS.dat')
...
sbend_devices('cu_hxr_survey.tape', 'elementdevices_sbends_cuH.dat')
sbend_devices('cu_sxr_survey.tape', 'elementdevices_sbends_cuS.dat')
